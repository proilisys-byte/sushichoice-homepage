      ...
      <section class="section section--dark" style="padding-top: calc(var(--header-height) + var(--space-3xl));">
        <div class="container">
          ...
          <div class="section-header text-center reveal">
            ...
            <p class="section-subtitle">전국의 스시초이스 매장을 소개합니다. 가까운 지점에서 프리미엄 회전초밥의 감동을 느껴보세요.</p>
            ...
            <div class="store-locator__list">
              <div class="store-tabs">
                ${storeData.map((store, index) => `
                  <button class="store-tab-btn ${index === 0 ? 'active' : ''}" data-store-id="${store.id}">
                  ...
                  <div class="store-panel ${index === 0 ? 'active' : ''}" id="panel-${store.id}">
                    ...
                    <div class="store-panel__info">
                      ...
                      <div class="store-panel__actions">
                        ...
                        <a href="/store/${store.id}" class="btn btn--secondary" data-link>상세 매장 정보</a>
                      </div>
                    </div>
                  </div>
                `).join('')}
