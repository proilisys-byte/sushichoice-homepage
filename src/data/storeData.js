...
export const storeData = [
  ...
  },
  {
    ...
    description: '은계지구 중심가에 위치하여 어린아이를 동반한 가족 외식 고객을 최우선으로 배려한 쾌적한 매장 설계와 균일가 접시당 2,000원 고퀄리티와 맛을 자랑하는 회전초밥전문점입니다. 쉐프들이 오마카세(당일준비한 신선한재료를 직접손으로 쥔초밥)방식으로 당일들어온 엄선된 제철의 신선한 재료만을 제공하고있으며 가족들이 드신다는 마음가짐으로 가족모임이나 연인들의 사랑을 받고있는 초밥맛집입니다.',
  ...
  },
  {
    ...
    address: '인천 연수구 컨벤시아대로 81 1층 128호 (대중교통 이용시 해양경찰청(이안송도방면))',
    tel: '0507-1427-4500',
    hours: '매일 11:30 - 21:30 (평일 Break 15:00~17:00 / 주말 Break 없음, 라스트 오더 21:00)',
    parking: '지하 주차장 무료 주차 등록',
    seats: '다찌 20석, 2인 프라이빗 부스 4개, 4인 패밀리 테이블 8개 (총 60석)',
    description: '송도에 위치하여 어린아이를 동반한 가족 외식 고객을 최우선으로 배려한 쾌적한 매장 설계와 균일가 접시당 2,000원 고퀄리티와 맛을 자랑하는 회전초밥전문점입니다. 저희는 쉐프들이 오마카세(직접 손으로 쥔 초밥)방식으로 당일 들어온 엄선된 제철의 신선한 재료만을 제공하고 있으며 우리 가족들이 드신다는 마음가짐으로 최선을 다해서 요리해 가족모임이나 연인들의 사랑을 받고 있는 송도 초밥 맛집 입니다. 오시는 모든분들의 행복하고 즐거운 식사시간을 만들어드리기 위해 최선을 다하겠습니다.',
