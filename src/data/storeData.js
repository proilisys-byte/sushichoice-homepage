...
export const storeData = [
  {
    ...
    address: '경기도 부천시 원미구 부일로243번길 52-4',
    addressLot: '경기도 부천시 원미구 상동 441-1',
    tel: '0507-1436-9955',
    hours: '매일 11:30 - 21:30 (평일 Break 15:00~17:00 / 주말 Break 16:00~16:30, 라스트 오더 21:00)',
    parking: '상가 지하 주차장 입차 시 2시간 무료 주차 지원',
    seats: '다찌(회전 레일 바) 18석, 독립 부스형 4인 패밀리 테이블 6개 (총 42석)',
    description: '스시초이스의 시작과 브랜드 철학이 시작된 본점입니다. 매 시간 철저한 레일 위생 소독과 셰프들의 친절한 응대로 편안한 식사를 선사합니다.',
  ...
  },
  {
    ...
    address: '경기 시흥시 은계로142번길 7-11 1층',
    tel: '031-313-1309',
    hours: '매일 11:30 - 21:30 (Break Time 없음, 라스트 오더 21:00)',
    parking: '매장 건물 전용 주차창 및 인근 공영 주차장 2시간 주차권 제공',
    seats: '다찌 16석, 독립 부스형 4인 테이블 8개, 아기 동반 전용 좌식 패밀리 존 2개 (총 56석)',
    description: '은계지구 중심가에 위치하여 어린아이를 동반한 가족 외식 고객을 최우선으로 배려한 쾌적한 매장 설계와 영유아 전용 편의시설을 완비하고 있습니다.',
